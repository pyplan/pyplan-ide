...
class ReportCreateUpdateSerializer(serializers.Serializer):
    ...
    is_fav = serializers.BooleanField(
        source="isFav", required=False, default=False)
    is_public = serializers.BooleanField(
        source="isPublic", required=False, default=False)
...
class ReportSerializer(serializers.Serializer):
    ...
    sharedToEveryone = serializers.BooleanField(
        source="is_public", required=False, default=False)
    isFav = serializers.BooleanField(
        source="is_fav", required=False, default=False)
    ...
    def get_isShared(self, obj):
        current_user_companies = self.context.get(
            "request").user.usercompanies.values_list('pk', flat=True)
...
class ReportImportSerializer(serializers.Serializer):
    ...
    shared_by = serializers.ListSerializer(
...
class SingleItemsSerializer(serializers.Serializer):
...
class ReportSetSharesSerializer(serializers.Serializer):
    usercompanies_ids = serializers.ListField(
        required=False, child=serializers.IntegerField())
    departments_ids = serializers.ListField(
        required=False, child=serializers.IntegerField())
    noShared = serializers.BooleanField(default=False)
    sharedToEveryone = serializers.BooleanField(default=False)
    sharedTo = serializers.BooleanField(default=False)
